...
export const sendContactForm = (variables) =>
  fetch("https://backoffice-chris-tp.herokuapp.com/contact", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
{
  articles(sort: "updatedAt:DESC", limit: 3) {
    id
    title
    description
    main_image {
...
query($id: ID!){category(id: $id){title, description}}
`;
